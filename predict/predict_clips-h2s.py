...
if __name__ == "__main__":
    ...
    output_file_name = f'H2S.dino.{args.split_name}.{args.split}.h5'
    meta_file_name = f"H2S.dino.{args.split_name}.{args.split}.json"
    ...
    if args.num_splits == len(json_files):
        ...
        with open(os.path.join(args.output_folder, f"H2S.dino.{args.split_name}.json"), "w") as f:
